...
def _d_toolchain_impl(ctx):
    ...
    if ctx.attr.config:
        ...
        d_toolchain_info = DToolchainInfo(
            ...
            linker_flags_for_d = _expand_toolchain_variables_in_flags(ctx, config.linker_flags_for_d, config),
            ...
            linker_flags_for_d_per_mode = _expand_toolchain_variables_in_flags_per_mode(ctx, config.linker_flags_for_d_per_mode, config),
